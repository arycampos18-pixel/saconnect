...
import {
  ...
  UserCircle, Inbox, Building2, ScanSearch,
} from "lucide-react";
...
export const MODULOS_CATALOGO: ModuloDef[] = [
  ...
  { id: "departamentos-gabinete", nome: "Departamentos do Gabinete", descricao: "Gerenciar departamentos, membros e histórico", icon: Building2, url: "/app/political/departments" },
  { id: "analise-politica", nome: "Análise Política Eleitoral", descricao: "Validação eleitoral, consultas API e análises", icon: ScanSearch, url: "/app/analise/dashboard" },
...
export const PRESETS_DEFAULT: Record<string, string[]> = {
  ...
  lideranca: TODOS_IDS.filter((id) => !["cadastros", "integracoes", "configuracoes"].includes(id)),
